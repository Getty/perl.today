        ...
        sub {
            ...
            my @user_notifications =
                ...
                {   prefetch => [qw( user_notification_group user )],
                    order_by =>
                        { -desc => 'user_notification_group.priority' },
                }
                )->all;
            ...
            if (@user_notifications) {
                ...
                for my $user_notification (@user_notifications) {
                    next
                        if defined
                        $notified_user_ids{ $user_notification->users_id };
                    next
                        if $self->users_id
                    ...
                    {
                        next
                            unless $user_notification->user_notification_group
                            ->filter->(
                            $user_notification->user_notification_group
                                ->sub_context eq ''
                    ...
                    my $group_context_id =
                        ...
                        : $user_notification->user_notification_group
                        ->sub_context eq '' ? $self->get_context_obj->id
                        : $self->get_related(
                    ...
                    $self->create_related(
                        'event_notifications',
                        {   event_notification_group_id =>
                                $event_notification_group->id,
